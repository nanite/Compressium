...
public enum CompressibleType {
    ...
    FALLING("falling", () -> new FallingDamageBlock(BlockBehaviour.Properties.of(Material.SAND))),
    NETHER_RACK("nether_rack", () -> new NetherrackBlock(BlockBehaviour.Properties.of(Material.STONE))),
    SOUL_SAND("soul_sand", () -> new SoulSandBlock(BlockBehaviour.Properties.of(Material.SAND))),
    POWERED("powered", () -> new PoweredBlock(BlockBehaviour.Properties.of(Material.STONE)));
