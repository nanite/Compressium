...
public enum CompressibleType {
    ...
    DIRT("block", props -> new Block(props.strength(1.5f).sound(SoundType.GRAVEL))),
    CLAY("block", props -> new Block(props.strength(1.5f).sound(SoundType.GRAVEL))),
    COPPER("block", props -> new Block(props.strength(1.5f).requiresCorrectToolForDrops().sound(SoundType.COPPER))),
